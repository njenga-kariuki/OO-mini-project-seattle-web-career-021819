# Ruby object relationships: recipes and allergens

A Flatiron School pair-programming exercise completed by Njenga Kariuki with [@bbpak](https://github.com/bbpak) in February 2019. The implementation models users, recipes, ingredients, recipe cards and allergens through Ruby objects and their relationships.

**Learning archive.** The original exercise and console examples are preserved. This repository includes the supplied curriculum and starter history; it has not been revalidated on a current Ruby environment.
